...
plot_ly (with(ISIP1volcano, plot(ISIP1volcano$X12_vs_13.log2fc, -log10(ISIP1volcano$X12_vs_13.fdr), pch=20))+
...
ggplot (data = ORF, aes(x= X12_vs_13.log2fc, y=-log10(X12_vs_13.fdr))) +
...
volcano <- ORF[c("kegg_desc", "X12_vs_13.log2fc", "X12_vs_13.fdr")]
