...
Frag_LHCs <- dplyr::filter(LHC_t1_t5_v2, grepl("Pseudo-nitzschia", Taxa))
...
LHC_t1_t5_v2 <- data.frame(LHC_t1_t5_v2[,-1], row.names = LHC_t1_t5_v2 [,1])

heatmap.2 (as.matrix(LHC_t1_t5_v2), 
             trace = "none",
             density = "none", 
             col = bluered(100),
             cexRow = 0.5, 
...
# "clust_3167" = "MetE", meth independent
# "clust_120" = "MetH", meth dependent
# "clust_3290" = "CBA1"


#heatmap_t1_t5 <- dplyr::filter (all_MCL, grepl("clust_3167 |clust_120 |clust_3290 ", name)) #B12 stuff

heatmap_t1_t5 <- dplyr::filter (all_MCL, grepl("clust_1820 ", name))
heatmap_t1_t5_v2 <- heatmap_t1_t5[c(148,55:59,61,62,64,65,67, 74:91)]

names(heatmap_t1_t5_v2) <- c("cluster", "ice-edge","T0_A", "T0_B", "T0_C", "T1_noFe_0","T1_Fe_0","T1_noFe_3","T1_Fe_3","T1_noFe_6","T1_Fe_6","A_NoFe_0.5", "B_NoFe_0.5", "C_NoFe_0.5", "A_Fe_0.5", "B_Fe_0.5", "C_Fe_0.5", "A_NoFe_3", "B_NoFe_3", "C_NoFe_3", "A_Fe_3", "B_Fe_3", "C_Fe_3","A_NoFe_6", "B_NoFe_6", "C_NoFe_6", "A_Fe_6", "B_Fe_6", "C_Fe_6" )

heatmap_t1_t5_v2 <- data.frame(heatmap_t1_t5_v2[,-1], row.names = heatmap_t1_t5_v2 [,1])

heatmap.2 (as.matrix(heatmap_t1_t5_v2), 
             trace = "none",
             density = "none", 
             col = bluered(100),
...
heatmap_unclustered_t1(B12_T1, "B12 related", "Pseudo-nitzschia")

#clusters from erin to look at
#4490, 2147, 3511,8360,10329


B12_stuff <- dplyr::filter(all_ORF_sub, grepl('clust_3167 |clust_120 |clust_3290 |clust_4490 |clust_2147 |clust_3511 |clust_8360 |clust_10329 ', name))
...
heatmap(pseudo_MCL,"title", "clust_3167 |clust_120 |clust_3290 |clust_4490 |clust_2147 |clust_3511 |clust_8360 |clust_10329 ")
...
rhodopsin play. delete after
```{r}
rhodopsin <- dplyr::filter(pseudo_frag_ORF, grepl("rhodopsin|Rhodopsin|clust_1548 ", name))
"clust_231" = "Rhodopsin_1", "clust_1548" = "Rhodopsin_2"
```
